<?php
/**
 * initialize variables (variable_name) from Page:
 * variable_name => comment
 */

$vars = [
    'site_name' => 'string', 'language' => 'string', 'favicon' => 'https://via.placeholder.com/16',
    ...
    /**
     * @var $heads array<App\Models\Head>
     */
    'heads' => '\App\Models\Head'
];
    ...
    <div class="wrapper text-center">
        <div class="wrapper-hero">
            ...
            <header class="main-header">
                <x-text-element tagName="h1" bem-class="main-header__heading" class-list="h1"  visible-text="Elektriker in Stuttgart"/>
                <x-text-element tagName="p" bem-class="main-header__text" class-list="h2"  visible-text="Notdienst Elektriker"/>
            </header>
            <main class="callus ">
        ...
        <div class="wrapper-comments">
            <div class="comments-section">
                ...
                <div class="comment">
                    ...
                    <div class="comment__text">
                        Durch Reparaturen in unserer Wohnung brauchten wir neuen Steckdosen. Von der Planung bis zur
                        Ausführung lief alles problemlos. Ich war zufrieden mit der Leistung.
                    </div>
                    <div class="comment__author">
                        Thomas Decker
                    </div>
